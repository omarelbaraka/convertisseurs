	  ...
	  strcat(lien, fichier);
       ...
       while(fgets(ligne, TAILLE_MAX, file) != NULL){
        ...
        newLigne = (char*)malloc(TAILLE_MAX * sizeof(char));
           ...
           if(( strstr(ligne, "+") || strstr(ligne, "Introduction") || strstr(ligne, "INTRODUCTION") || strstr(ligne, "introduction")||strstr(ligne, "I NTRODUCTION")) 
                 && condition == 0){
                   break;
           }
...
char * trouver_email(char * nomFichier){
          char * buffer;
          buffer = (char*)malloc(TAILLE_MAX * sizeof(char));
...
char * trouver_introduction(char * fichier){
	  ...
	  ligne = (char *) malloc(TAILLE_MAX * sizeof(char));
        ...
        while(fgets(ligne, TAILLE_MAX, file) != NULL){
            ...
            if((ligne[0] == '2'|| ligne[1] == '2' || strstr(ligne, "II.")) && ( strstr(ligne, "2.") || strstr(ligne,"2 ") || strstr(ligne, "II.") ) && !strstr(ligne,"20")
                   && strlen(ligne)<55 && condition == 0 ){
                 break;
            }
...
char * trouver_corps(char * fichier){
          char * buffer;
          buffer = (char*)malloc(TAILLE_MAX * sizeof(char));
	  ...
	  ligne = (char *) malloc(TAILLE_MAX * sizeof(char));
        ...
        while(fgets(ligne, TAILLE_MAX, file) != NULL){
           ...
           if((strstr(ligne, "Conclusion") || strstr(ligne, "Discussion") || strstr(ligne, "CONCLUSION")||strstr(ligne, "C ONCLUSION") ||strstr(ligne, "Conclusions") && condition == 0)){
                  break; 
           }
...
char * trouver_conclusion(char * fichier){
	  ...
	  int i = 1, numLigne = 0;
	  while(fgets(ligne, TAILLE_MAX, file) != NULL){
	         if((strstr(ligne, "conclusions") || strstr(ligne, "conclusion") || strstr(ligne, "CONCLUSIONS")||strstr(ligne, "CONCLUSION") || strstr(ligne, "Conclusions") || strstr(ligne,    
	                        "Conclusion")&& strlen(ligne)<40)) numLigne = i;
	         else i++;
	  }
	 
	  if(numLigne == 0) return "il n y a pas";
	  
	    char * ligne2;
            ligne2 = (char*)malloc(TAILLE_MAX);
	  
          int condition = 1;
          int j;
          FILE * file2 = fopen(lien, "r");
          
          for(int j = 1; j<numLigne;j++){
             fgets(ligne2, TAILLE_MAX, file2);
          }
          
        while(fgets(ligne2, TAILLE_MAX, file2) != NULL){
             
            char * newLigne;
            newLigne = (char*)malloc(TAILLE_MAX * sizeof(char));
            
            if( (strstr(ligne2, "Acknowledg") || strstr(ligne2, "ACKNOWLEDG") ||  strstr( ligne2,"References")||
                                 strstr( ligne2,"REFERENCES") ||strstr( ligne2,"references") || strstr( ligne2,"R EFERENCES")) && condition == 0 && strlen(ligne2)<40)   
            {                                                       	
                 break; 
            }
        
            if(( ((strstr(ligne2, "conclusions") || strstr(ligne2, "conclusion") || strstr(ligne2, "CONCLUSIONS")||strstr(ligne2, "CONCLUSION")|| strstr(ligne2, "Conclusions") || strstr(ligne2,    
	                        "Conclusion")) && strlen(ligne2)<40))|| condition == 0){
...
char * trouver_discussion(char * fichier){
	  ...
	  int i = 1, numLigne = 0;
	  while(fgets(ligne, TAILLE_MAX, file) != NULL){
	         if((strstr(ligne, "discussion") || strstr(ligne, "discussions") || strstr(ligne, "DISCUSSIONS")||strstr(ligne, "DISCUSSION") || 
	               strstr(ligne, "Discussion") || strstr(ligne, "Discussions")) && strlen(ligne)<40) numLigne = i;
	         else i++;
	  }
	  ...
	  if(numLigne == 0) return "il n y a pas";
        ...
        while(fgets(ligne2, TAILLE_MAX, file2) != NULL){
            ...
            if( condition == 0 && (strstr(ligne2, "Acknowledg") || strstr(ligne2, "ACKNOWLEDG") ||  strstr( ligne2,"References")||
                                 strstr( ligne2,"REFERENCES") ||strstr( ligne2,"references") || strstr( ligne2,"R EFERENCES")
                                 || strstr(ligne2, "conclusions") || strstr(ligne2, "conclusion") || strstr(ligne2, "CONCLUSIONS")||strstr(ligne2, "CONCLUSION") 
                                 || strstr(ligne2, "Conclusions") || strstr(ligne2,"Conclusion")) && strlen(ligne2)<40)   
            {                                                       	
                 break; 
            }
        
            if( ((strstr(ligne2, "discussion") || strstr(ligne2, "discussions") || strstr(ligne2, "DISCUSSIONS")||strstr(ligne2, "DISCUSSION") 
                   || strstr(ligne2, "Discussion") || strstr(ligne2, "Discussions")) && strlen(ligne2)<40) || condition == 0){
            ...
            if(strlen(buffer)==0) return "il n y a pas";
            return buffer;
}
	 ...
	 system("mkdir resume_fichier");  // créer un nouveau dossier resume_fichier
        ...
        {   
              //creer un nouveau fichier
                ...
                char * email = trouver_email(chaine);
                char * corps = trouver_corps(chaine);
              ...
              // if(conclusion == NULL) conclusion = "il n y a pas de conclusion";
                ...
                snprintf(buffer8,TAILLE_MAX,"echo les auteur sont : \"%s et les email sont : %s\" >> %s",auteurs, email,chaine);
                system(buffer8);
                system(saut);
                ...
                // ajouter le corps du fichier
                char * buffer16;
                buffer16 = (char*)malloc(TAILLE_MAX * sizeof(char));
                snprintf(buffer16,TAILLE_MAX,"echo le corps est : \"%s\" >> %s",corps,chaine);
                system(buffer16);
                system(saut);
